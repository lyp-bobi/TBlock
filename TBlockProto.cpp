...
void TBlockProto::cvt_greedy(Trajectory &traj) {
    double x, y;
    m_points.clear();
...
inline int TBlockProto::locateTime(int l, int h, double time, int dir) {
    int m,ll = l, hh =h;
    while (l < h - 1) {
        m = (l+h)/2;
